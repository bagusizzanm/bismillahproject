...
<body class="font-poppins overflow-x-hidden">
    ...
    <header class="w-full flex items-center z-10 py-5 md:py-10 px-10" id="nav">
        <nav class="w-full flex justify-between items-center">
            ...
            <a href="{{ url('/register_user') }}" class="text-[#AF2654] hover:text-[#791B4D]">Register</a>
        </nav>
    </header>
    ...
    <section class="flex min-h-full flex-col justify-center px-6 py-5 lg:px-5">
        <div class="flex justify-center align-middle mx-auto">
            <div class=" w-full md:w-[30rem] px-12">
                <h2 class="text-3xl font-semibold tracking-wide text-center">Selamat Datang!</h2>
                <div class="mt-5">
                    <a href=""
                        class="duration-500 w-full px-5 py-2.5 text-gray-500 flex items-center border rounded-lg hover:border-[#AF2654] hover:cursor-pointer">

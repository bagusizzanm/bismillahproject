...
<body class="font-poppins overflow-x-hidden">
    ...
    <header class="w-full flex items-center z-10 py-5 px-10 md:py-10" id="nav">
        <nav class="w-full flex justify-between items-center">
            ...
            <a href="{{ url('/login_vendor') }}" class="text-[#AF2654] hover:text-[#791B4D]">Login</a>
        </nav>
    </header>
    ...
    <section class="flex min-h-full flex-col justify-center px-6 py-5 lg:px-5">
        <div class="flex justify-center align-middle mx-auto">
            <div class=" w-full md:w-[30rem] px-12">
                <h2 class="text-3xl font-semibold tracking-widest">Create Your Vendor</h2>
                    ...
                    <div class="py-4 block">
                        <form action="">
                            ...
                            <label for="business_name"
                                class="text-sm font-semibold after:content-['*'] after:ml-0.5 after:text-red-400">Business
                                Name</label>
                            <input type="text" placeholder="Business Name"
                                class="business_name text-sm my-2 p-3 rounded-lg border w-full focus:outline-none focus:border-[#AF2654] bg-gray-50 text-gray-900"
                                id="business_name">
                            <label for="email"
                            ...
                            <div class="flex justify-center mt-3">
                                <label for="terms" class="text-sm font-medium text-gray-900 dark:text-gray-500">Have
                                    an account? <a href="{{ url('/login_vendor') }}"
                                        class="text-[#AF2654] hover:underline">Login to your dashboard</a></label>
                            </div>
                        </form>
                    </div>
                </div>
